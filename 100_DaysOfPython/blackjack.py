...
def calculate_score(list_of_cards):
    ...
    if 11 in list_of_cards and 10 in list_of_cards and len(list_of_cards) == 21:
        return 0
    if 11 in list_of_cards and sum(list_of_cards) > 21:
        list_of_cards.remove(11)
        list_of_cards = list_of_cards.append(1)
...
#Hint 14: Ask the user if they want to restart the game. If they answer yes, clear the console and start a new game of blackjack and show the logo from art.py.############### Blackjack Project #####################
